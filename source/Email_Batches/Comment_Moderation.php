...
class Comment_Moderation extends Prompt_Email_Batch {
	...
	public function add_recipient_addresses( $addresses ) {
		...
		/**
		 * Filter: replyable_moderation_recipient_addresses
		 *
		 ...
		 */
		$addresses = apply_filters( 'replyable_moderation_recipient_addresses', $addresses, $this->comment->comment_ID, $this->comment->comment_post_ID );
